...
**RDEx-MOP 是 RDE 研究线中面向有界约束多目标优化的 CEC 2025 U-score 第 1 名参赛方案。**
...
| 基准 | 10 个多目标优化问题 |
| 运行次数 | 每个问题 30 次独立运行 |
| 预算 | 每个问题 100000 次函数评价 |
| 总分 | 36343.5 |
| 论文 | [arXiv:2603.27092](https://arxiv.org/abs/2603.27092) |
...
| --- | --- |
| `benchmark/` | 公开基准材料 |
| `code/rdex-mop/main.py` | 该赛道专用运行入口 |
| `code/rdex-mop/main.m` | MATLAB 运行入口 |
| `code/rdex-mop/Algorithm/` | 最终算法源代码和运行时类 |
| `code/rdex-mop/Metrics/` | 内置 MATLAB 运行时使用的指标函数 |
