...
**RDEx-CSOP 是 RDE 研究线中面向有界约束的约束单目标优化的 CEC 2025 U-score 第 1 名参赛方案。**
...
| --- | --- |
| 成绩 | U-score 第 1 名 |
| 赛道 | CEC 2025 BC-CSOPs |
| 基准 | 28 个 CEC 2017 约束实参数值优化问题 |
| 运行次数 | 每个问题 25 次独立运行 |
| 预算 | 20000 x D 次函数评价 |
| 总分 | 53680.5 |
| 论文 | [arXiv:2603.27090](https://arxiv.org/abs/2603.27090) |
...
| --- | --- |
| `benchmark/` | 公开基准材料 |
| `code/rdex-csop/main.py` | 该赛道专用运行入口 |
| `code/rdex-csop/RDEx.cpp` | 最终算法源代码 |
| `code/rdex-csop/cec17_test_COP.cpp` | 基准评价器 |
| `code/rdex-csop/inputData/` | 必要的基准输入数据 |
...
生成结果会写入 `code/rdex-csop/outputs/`。
