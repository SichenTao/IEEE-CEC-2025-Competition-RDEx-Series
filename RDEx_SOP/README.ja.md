...
**RDEx-SOP は、RDE 研究ラインにおける有界制約単目的最適化向けの CEC 2025 Rank 1 U-score エントリです。**
...
| `code/rdex-sop/main.py` | トラック専用の実行エントリ |
| `code/rdex-sop/RDEx.cpp` | 最終アルゴリズムのソースコード |
| `code/rdex-sop/cec17_test_func.cpp` | ベンチマーク評価器 |
| `code/rdex-sop/input_data/` | 必要なベンチマーク入力データ |
...
生成された出力は `code/rdex-sop/outputs/` に書き込まれます。
